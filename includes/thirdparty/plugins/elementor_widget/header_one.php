...
class wpsection_header_one_Widget extends \Elementor\Widget_Base {
	public function get_name() {
		return 'wpsection_header_one';
	}

	public function get_title() {
		return __( 'header_one', 'wpsectionsupport' );
	}
...
// Register widget
Plugin::instance()->widgets_manager->register( new \wpsection_header_one_Widget() );
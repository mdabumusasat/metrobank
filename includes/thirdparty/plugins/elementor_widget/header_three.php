...
class wpsection_header_three_Widget extends \Elementor\Widget_Base {
	public function get_name() {
		return 'wpsection_header_three';
	}

	public function get_title() {
		return __( 'Header Three', 'wpsectionsupport' );
	}
...
// Register widget
Plugin::instance()->widgets_manager->register( new \wpsection_header_three_Widget() );